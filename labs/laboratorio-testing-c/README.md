...
> R: No coincide, total = 2050, con descuento = 1845
...
> R: lo que hace es inicializar el carrito, por eso es importante llamarla antes de usarla.
...
> R: el operador incorrecto es el =< y deberia ser solo <
...
> R: Las lineas de carrito_descuento no se ejecutaron
...
> R: el de integracion, probamos varias funciones, en el unitario, probamos una sola. Primero detectó el bug el test_unitario
...
> R: este enfoque es mejor ya que nos ahorramos el tiempo de leer linea por linea, gracias a los tests podemos ir directo a la funcion que esta fallando.
...
> R: porque tenia una cantidad 1, por lo que no debia multiplicarlo para contar el precio total.
